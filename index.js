...
execSync(`cd ${config.folder} && git config user.email "${config.user_email}" && git config user.name "${config.user_name}" && git add . && git commit --allow-empty -m "${config.commit}"`, { cwd });
